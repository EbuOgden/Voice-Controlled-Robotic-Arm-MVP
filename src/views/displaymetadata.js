...
exports.showResult = function(msg, model) {
 ...
 var split = text.split(" ");
      ...
      if((split[0] === "left") && (split[0] == "left")){
        degree = parseInt(split[1]);
      ...
      if((split[0] === "right") && (split[0] == "right")){
        degree = parseInt(split[1]);
      ...
      if((split[0] === "up") && (split[0] == "up")){
        var degree = parseInt(split[1]);
...
/* if(text.toString().trim() === "right"){
	$.post("/leftCommand",function(data, status){console.log(status);})
		console.log("RIGHT");} */
